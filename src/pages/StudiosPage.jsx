      ...
      <div className="studios min-vh-100">
        <Container>
          ...
          <Row>
            ...
            <Col className="border border-dark shadow rounded" data-aos="fade-up" data-aos-duration="1000">
              ...
              <div className="ket d-flex justify-content-between align-items-center px-3 pb-3">
                ...
                <a href="https://www.google.com/maps/search/studio/" className="btn btn-dark rounded-1">
                  Studio Terdekat
                </a>
              </div>
            </Col>
          ...
          <Row>
            ...
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m16!1m12!1m3!1d94659.67126584469!2d108.85239774335456!3d-6.912010404860451!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!2m1!1sstudio!5e0!3m2!1sen!2sid!4v1720800664173!5m2!1sen!2sid"
              width="1200"
              height="600"
              allowfullscreen=""
              loading="lazy"
